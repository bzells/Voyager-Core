...
public class GeneratorMultis {
    ...
    public static final MultiblockMachineDefinition HELPER_CALORIE_CONVERTER = VOYAGERCORE_REGISTRATE
            ...
            .pattern(def -> FactoryBlockPattern.start()
                ...
                .aisle("baccaaaaaccab", "aaaebaaabeaaa", "aaaebckcbeaaa", "aaaebaaabeaaa", "baccaaaaaccab")
                ...
                .where("a", Predicates.any())
                            ...
                            .where("k", Predicates.abilities(VoyagerPartAbilities.HELPER_HOLDER))
                            ...
                            .where("g", Predicates.blocks(GTBlocks.CASING_TITANIUM_PIPE.get()))
                    .build())
